...
<body>
        ...
        <nav>
            <div class="containernav">
                ...
                <ul class="links">
                    ...
                    <li class="link navegacion--lista__activo"><a href="Nosotros.php">Nosotros</a></li>
    ...
    <main>
        <section class="connosotros-fondo">
            <div class="connosotros">
                <h2>SOBRE NOSOTROS</h2>
                <div class="cardcontenedor"></div>
                <div class="card parpadeo">
                    ...
                    <div class="face back">
                        <h3>MISION</h3>
                        <P>Nuestra misión es ofrecer a nuestros huéspedes una estancia inolvidable, brindándoles un servicio de alta calidad, comodidad y atención personalizada. Nos esforzamos por superar las expectativas de nuestros clientes en cada visita, cuidando de cada detalle para crear recuerdos felices y duraderos.</P>
                        <div class="link">
                            <a href="#">Datails</a>
                        </div>
                    </div>
                ...
                <div class="card parpadeo">
                    ...
                    <div class="face back">
                        <h3>VISION</h3>
                        <P>La visión de nuestro hotel es convertirse en el destino preferido de viajeros y huéspedes locales que buscan una experiencia de hospitalidad excepcional en un entorno único y relajante. Queremos ser reconocidos por nuestro compromiso con la satisfacción del cliente, la excelencia en el servicio.</P>
                        <div class="link">
                            <a href="#">Datails</a>
                        </div>
                    </div>
                ...
                <div class="card parpadeo">
                    ...
                    <div class="face back">
                        ...
                        <p>
                            Garantizar que los huéspedes tengan una experiencia positiva.
                        </p>
                        <li>Rentabilidad:</li>
                        <p>
                            Mantener y mejorar la rentabilidad es esencial para la supervivencia del hotel.
                        </p>

                        <li>Fidelización de clientes:</li>
                        <p>
                            Atraer a clientes recurrentes y crear sclientes leales.
                        </p>
